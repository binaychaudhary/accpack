<?php
	...
	if($formName=="sales") {
		...
		$queryString = "SELECT i.*, g.group_code, u.ShortName as unit from inv_item i left join inv_group g on i.group_id = g.id left join unit u on i.unit_id = u.id left join department dpt on i.department_id = dpt.id left join inv_item_rate rt on rt.itemId=i.id".$cr;
	}
