<?php
	...
	$queryString = "SELECT g.*, v.vdescription,l.no_of_day from guest_register g";
	$queryString.= " left join visit_type v on g.visit_type = v.id";
	$queryString.= " left join lodge l on g.id = l.guest_id".$cr;
