<?php
	...
	$interest_per=$data->$data->interest_per;
	...
	$payment_type = $r['payment_type'];
	 ...
	 //consulta sql
	 $query = sprintf("UPDATE loan_detail SET loan_ac_id = '%d', g_father_name = '%s', father_name='%s', applied_loan_amount = '%s', loan_purpose='%s', approved_amount='%s', loan_approved_date_bs='%s', loan_approved_date_ad='%s', loan_payment_date_bs='%s',loan_payment_date_ad='%s', interest_per='%s', interest_type_id='%d', payment_type_id='%d',  loan_commitee_approver='%d',  managing_commitee_approver='%d' WHERE id=%d",
...
// $query = sprintf("UPDATE loan_detail SET loan_ac_id = '%d',  approved_amount='%s' WHERE id=%d",
// 		$conn->real_escape_string($loan_ac_id),
// 		$conn->real_escape_string($approved_amount),
// 		$conn->real_escape_string($id)
// 	);
