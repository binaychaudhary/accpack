<?php
	...
	$purchase_from_acno = $_REQUEST['purchase_from_acno'];
	...
	$insertSql = sprintf("insert into stock (fiscalYear, sourceCodeId, entryNo, itemId, rate, qty, amount, purchase_date_bs, purchase_date_ad, status, purchase_from, entry_date_bs, entry_date_ad, qty_out, unitId, discount_rate,discount_amount, net_amount,ref_no) values ('%s','%d','%s','%d','%s','%s','%s','%s','%s','%d','%s','%s','%s','%s','%d','%s','%s','%s','%s')",
		...
		$conn->real_escape_string($purchase_from_acno),
		$conn->real_escape_string($purchase_date_bs),
		$conn->real_escape_string($purchase_date_ad),
