 ...
 */
Ext.define("ExtMVC.ux.grid.Printer", {
    ...
    statics: {
         ...
         */
        print: function(reportName, fiscalYear, upto, grid, featureId, printhtml) {
...
//            });
            ...
            if (this.stylesheetPath === null) {
                var scriptPath = Ext.Loader.getPath('ExtMVC.ux.grid.Printer');
                this.stylesheetPath = scriptPath.substring(0, scriptPath.indexOf('Printer.js')) + 'gridPrinterCss/print-preview.css';
                this.logopath = scriptPath.substring(0, scriptPath.indexOf("Printer.js")) + "gridPrinterCss/logo.png";
            }
           // debugger;
            ...
            var htmlMarkup = [
                ...
                '<html class="' + Ext.baseCSSPrefix + 'ux-grid-printer">',
                  ...
                  '<h1>' + this.mainTitle + '</h1>',
                    '<table><tr>',
                    '<td width="15%" align="left"><img src="' + this.logopath + '" style="height:70px;"></td>',
                    '<td width="70%" align="center">',
                        '<span style="font-size:x-large">Chaudhary Co-operative Limite</span><br />',
                        '<span style="font-size:large">Sinamangal, Kathmandu</span></br>',
                        '<span style="font-size:x-large">' + reportName + '</span></td>',
                    '<td width="15%" align="right"></td></tr></table>',
                   '<div width="100%">',
                        '<div style="float:left; font-weight:bold" border="1px solid red" width="30%">' + 'Fiscal Year: '+ fiscalYear + '</div>',
                        '<div style="float:right;  font-weight:bold" align="right"  border="1px solid red"  width="30%">' + upto + '</div>',
                   '</div><br>',
                    ...
                    '<div id="container" style="width:100%; text-align:center;">',
                        '<div id="left" style="float:left; font-weight:bold; font-size:14px; width:100px;" ><div align="center">___________<br>Prepared By</div></div>',
                        '<div id="center" style="display: inline-block;font-weight:bold;font-size:14px; margin:0 auto; width:100px;"><div align="center">___________<br>Checked By</div></div>',
                        '<div id="right" style="float:right;font-weight:bold;font-size:14px;"><div align="center">___________<br>Approved By</div></div>',
                    '<div>',
            ...
            var win = window.open('', 'SyslogMessages', 'status=1,toolbar=1,menubar=1,resizable=1,scrollbars=1,height=600,width=800');
            ...
            if (grid.store.isGrouped() && groups && groups.length && feature )
            {
                ...
                var bodyTpl = [
                    ...
                    '</tpl>',
                    {
                        ...
                        // Use the getSummary from Ext 4.1.3.  This function for 4.2.1 has been changed without updating the documentation
                        // In 4.2.1, group is a group object from the store (specifically gstore.groups[i].items).
                        /**
                         * Get the summary data for a field.
                         * @private
                         * @param {Ext.data.Store} store The store to get the data from
